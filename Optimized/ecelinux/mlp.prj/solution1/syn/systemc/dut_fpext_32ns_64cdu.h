...
// ==============================================================
#ifndef __dut_fpext_32ns_64cdu__HH__
#define __dut_fpext_32ns_64cdu__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_fpext_32ns_64cdu) {
    ...
    SC_CTOR(dut_fpext_32ns_64cdu):  ACMP_fpext_U ("ACMP_fpext_U") {
