...
// ==============================================================
#ifndef __dut_fsqrt_32ns_32ceu__HH__
#define __dut_fsqrt_32ns_32ceu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_fsqrt_32ns_32ceu) {
    ...
    SC_CTOR(dut_fsqrt_32ns_32ceu):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
