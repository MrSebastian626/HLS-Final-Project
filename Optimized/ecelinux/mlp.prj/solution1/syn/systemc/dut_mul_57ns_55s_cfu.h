...
// ==============================================================
#ifndef __dut_mul_57ns_55s_cfu__HH__
#define __dut_mul_57ns_55s_cfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_57ns_55s_cfu) {
    ...
    SC_CTOR(dut_mul_57ns_55s_cfu):  ACMP_mul_us_U ("ACMP_mul_us_U") {
