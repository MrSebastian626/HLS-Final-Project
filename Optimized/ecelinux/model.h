...
// Weights and biases
const weight_t w1[N_INPUTS][N_HIDDEN0] = {
#include "data/w1.h"
};

const weight_t b1[N_HIDDEN0] = {
#include "data/b1.h"
};

const weight_t w2[N_HIDDEN0][N_HIDDEN1] = {
#include "data/w2.h"
};

const weight_t b2[N_HIDDEN1] = {
#include "data/b2.h"
};

const weight_t w3[N_HIDDEN1][N_HIDDEN2] = {
#include "data/w3.h"
};

const weight_t b3[N_HIDDEN2] = {
#include "data/b3.h"
};

const weight_t w4[N_HIDDEN2][N_HIDDEN3] = {
#include "data/w4.h"
};

const weight_t b4[N_HIDDEN3] = {
#include "data/b4.h"
};

const weight_t w5[N_HIDDEN3][N_OUTPUTS] = {
#include "data/w5.h"
};

const weight_t b5[N_OUTPUTS] = {
#include "data/b5.h"
};
