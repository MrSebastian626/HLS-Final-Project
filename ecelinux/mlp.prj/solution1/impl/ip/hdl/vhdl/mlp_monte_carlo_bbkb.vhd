...
entity mlp_monte_carlo_bbkb_rom is 
    generic(
             DWIDTH     : integer := 16; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of mlp_monte_carlo_bbkb_rom is 
...
entity mlp_monte_carlo_bbkb is
    generic (
...
architecture arch of mlp_monte_carlo_bbkb is
    component mlp_monte_carlo_bbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_monte_carlo_bbkb_rom_U :  component mlp_monte_carlo_bbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
