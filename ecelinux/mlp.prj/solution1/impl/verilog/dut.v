...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((icmp_ln23_fu_128_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln23_fu_128_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_0_reg_92 <= 4'd0;
    end else if ((~((icmp_ln23_fu_128_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln23_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln23_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        input_V_address0 = zext_ln24_fu_140_p1;
...
always @ (*) begin
    if ((~((icmp_ln23_fu_128_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln23_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        input_V_ce0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        input_V_ce0 = grp_mlp_monte_carlo_fu_103_input_V_ce0;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((icmp_ln23_fu_128_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln23_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((icmp_ln23_fu_128_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln23_fu_128_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = ((icmp_ln23_fu_128_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_ignore_call0 = ((icmp_ln23_fu_128_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0));
end
...
assign icmp_ln23_fu_128_p2 = ((i_0_reg_92 == 4'd9) ? 1'b1 : 1'b0);

assign zext_ln24_fu_140_p1 = i_0_reg_92;
