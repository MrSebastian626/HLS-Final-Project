...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0))) and (icmp_ln23_fu_128_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0))) and (icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, strm_in_V_V_empty_n, strm_out_V_V_full_n, ap_CS_fsm_state2, icmp_ln23_fu_128_p2, ap_CS_fsm_state3, ap_CS_fsm_state4, grp_mlp_monte_carlo_fu_103_ap_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((not(((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0))) and (icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif ((not(((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0))) and (icmp_ln23_fu_128_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    ap_block_state2_assign_proc : process(strm_in_V_V_empty_n, icmp_ln23_fu_128_p2)
    begin
                ap_block_state2 <= ((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0));
    end process;


    ap_block_state2_ignore_call0_assign_proc : process(strm_in_V_V_empty_n, icmp_ln23_fu_128_p2)
    begin
                ap_block_state2_ignore_call0 <= ((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0));
    end process;
    ...
    icmp_ln23_fu_128_p2 <= "1" when (i_0_reg_92 = ap_const_lv4_9) else "0";

    input_V_address0_assign_proc : process(ap_CS_fsm_state2, icmp_ln23_fu_128_p2, ap_CS_fsm_state3, grp_mlp_monte_carlo_fu_103_input_V_address0, zext_ln24_fu_140_p1)
    begin
        if (((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            input_V_address0 <= zext_ln24_fu_140_p1(4 - 1 downto 0);
    ...
    input_V_ce0_assign_proc : process(strm_in_V_V_empty_n, ap_CS_fsm_state2, icmp_ln23_fu_128_p2, ap_CS_fsm_state3, grp_mlp_monte_carlo_fu_103_input_V_ce0)
    begin
        if ((not(((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0))) and (icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    input_V_we0_assign_proc : process(strm_in_V_V_empty_n, ap_CS_fsm_state2, icmp_ln23_fu_128_p2)
    begin
        if ((not(((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0))) and (icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    strm_in_V_V_blk_n_assign_proc : process(strm_in_V_V_empty_n, ap_CS_fsm_state2, icmp_ln23_fu_128_p2)
    begin
        if (((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    strm_in_V_V_read_assign_proc : process(strm_in_V_V_empty_n, ap_CS_fsm_state2, icmp_ln23_fu_128_p2)
    begin
        if ((not(((icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (strm_in_V_V_empty_n = ap_const_logic_0))) and (icmp_ln23_fu_128_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    zext_ln24_fu_140_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_92),64));
end behav;
