...
// ==============================================================
#ifndef __dut_mac_muladd_16tde__HH__
#define __dut_mac_muladd_16tde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_16tde) {
    ...
    SC_CTOR(dut_mac_muladd_16tde):  simcore_mac_0_U ("simcore_mac_0_U") {
