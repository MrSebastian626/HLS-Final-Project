...
// ==============================================================
#ifndef __dut_mac_muladd_16vdy__HH__
#define __dut_mac_muladd_16vdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_16vdy) {
    ...
    SC_CTOR(dut_mac_muladd_16vdy):  simcore_mac_2_U ("simcore_mac_2_U") {
