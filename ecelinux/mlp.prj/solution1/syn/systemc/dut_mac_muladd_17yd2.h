...
// ==============================================================
#ifndef __dut_mac_muladd_17yd2__HH__
#define __dut_mac_muladd_17yd2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_17yd2) {
    ...
    SC_CTOR(dut_mac_muladd_17yd2):  simcore_mac_4_U ("simcore_mac_4_U") {
