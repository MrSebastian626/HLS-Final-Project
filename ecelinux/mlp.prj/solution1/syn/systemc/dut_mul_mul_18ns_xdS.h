...
// ==============================================================
#ifndef __dut_mul_mul_18ns_xdS__HH__
#define __dut_mul_mul_18ns_xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_mul_18ns_xdS) {
    ...
    SC_CTOR(dut_mul_mul_18ns_xdS):  ACMP_smul_us_U ("ACMP_smul_us_U") {
