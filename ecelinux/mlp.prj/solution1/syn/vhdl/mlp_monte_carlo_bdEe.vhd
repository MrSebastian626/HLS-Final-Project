...
entity mlp_monte_carlo_bdEe_rom is 
    generic(
             DWIDTH     : integer := 15; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of mlp_monte_carlo_bdEe_rom is 
...
entity mlp_monte_carlo_bdEe is
    generic (
...
architecture arch of mlp_monte_carlo_bdEe is
    component mlp_monte_carlo_bdEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_monte_carlo_bdEe_rom_U :  component mlp_monte_carlo_bdEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
